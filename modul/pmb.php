...
/* CTA Section */
.cta {
  position: relative; /* untuk layer */
  background: url("../img/yaperi.jpg") center center / cover no-repeat fixed;
  padding: 3rem 0; /* dikurangi biar lebih ringkas */
  overflow: hidden;
}

/* Layer hitam transparan lebih gelap */
.cta::before {
  content: "";
  position: absolute;
...
/* Konten tetap di atas layer */
.cta > .container {
  position: relative;
  z-index: 2;
 text-align: center;
  padding-top: 2rem; /* tambah jarak dari atas, semakin besar semakin turun */
}

/* Heading & paragraph */
.cta h3 {
  color: #fff;
  font-size: clamp(1.2rem, 3.5vw, 1.5rem); /* lebih kecil & responsive */
  font-weight: 700;
...
.cta p {
  color: #fff;
  font-size: clamp(1.25rem, 4vw, 1.75rem); /* lebih kecil & responsive */
  margin-bottom: 0.5rem;
}
...
.cta .cta-btn {
  ...
  font-weight: 600;
  font-size: clamp(0.75rem, 1.5vw, 0.9rem); /* lebih kecil & responsive */
  letter-spacing: 0.05rem;
  display: inline-block;
  padding: 0.4rem 1.25rem; /* lebih ringkas */
...
@media (max-width: 991.98px) {
   .cta > .container {
    padding-top: 1.5rem; /* turun lebih sedikit di tablet */
  }
  .cta {
    padding: 2.5rem 1.5rem; /* lebih ringkas */
  }
  .cta h3 {
    font-size: clamp(1.1rem, 4vw, 1.4rem);
  }
.cta p {
  font-size: clamp(0.875rem, 4vw, 1.1rem); /* lebih kecil & tetap responsive */
}
  .cta .cta-btn {
...
@media (max-width: 576px) {
  .cta > .container {
    padding-top: 1rem; /* turun lebih sedikit di HP */
    margin-left: -1rem;
  }
  .cta {
    padding: 2rem 1rem; /* ringkas */
  }
  .cta h3 {
    font-size: clamp(1rem, 5vw, 1.2rem);
  }
.cta p {
  font-size: clamp(0.75rem, 3.5vw, 1rem); /* lebih kecil & responsive */
}
.cta .cta-btn {
...
#about .row {
  display: flex;
  flex-wrap: nowrap; /* gambar & teks sejajar di PC */
  justify-content: center;
  align-items: center;
  gap: 2rem;
  padding: 2rem 0;
...
/* Gambar */
.img-col img {
  width: 75%; /* biar proporsional dan responsif */
  max-width: 350px; /* batas maksimal supaya nggak kegedean */
  height: auto; /* biar nggak ketarik */
  margin-left: 4rem; /* ganti dari 89px jadi pakai rem */
  margin-top: 6rem; /* ganti dari 100px ke rem */
  border-radius: 1rem;
...
#about .info-daftar {
  text-align: left;
  margin-top: -0rem; /* jaraknya dikecilin biar deket ke konten atas */
   margin-left: -1.7rem;
}

#about .info-daftar h5 {
  font-size: 1rem; /* judulnya lebih kecil */
  margin-bottom: 0.4rem;
  color: #151515;
  font-weight: 600;
}

#about .info-daftar ul {
  list-style: none;
  padding-left: 1.3rem; /* sedikit masuk ke kanan */
  font-size: 0.87rem;
  color: #444;
...
@media (max-width: 992px) {
  #about .row {
    flex-wrap: wrap; /* biar gambar & teks numpuk */
    gap: 1.5rem;
    padding: 1.5rem 1rem;
  }
...
#about .content {
  text-align: left;
  width: 100%;
  padding: 0 1rem;              /* ruang aman kiri-kanan */
  box-sizing: border-box;
  overflow-wrap: break-word;    /* pecah kata panjang */
  word-wrap: break-word;
  white-space: normal;
  max-width: 100%;
  margin-top: -5rem;            /* jarak atas khusus HP */
}

/* ====== INFO PENDAFTARAN (BAGIAN BAWAH) ====== */
#about .info-daftar {
  text-align: left;
  width: 100%;
  padding: 0 1rem;              /* ruang aman kiri-kanan */
...
/* jarak antar elemen diatur rapet */
#about .row {
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
  gap: 0.8rem; /* sebelumnya 0rem bisa diganti 0.8rem biar gak terlalu nempel */
  width: 100%;
  margin: 0;
  padding: 0;
}
/* Kolom aman di layar kecil */
#about .col-lg-6 {
  width: 100%;
  max-width: 100%;
  box-sizing: border-box;
...
#about .col-lg-6 img {
  ...
  transition: transform 0.3s ease;
  margin: 0 auto;
  margin-top: 5rem; /* khusus HP */
  margin-left:6%;
}

/* ====== TEKS DAN LIST ====== */
/* ====== KONTEN UTAMA (TEKS UTAMA) ====== */
#about .content {
  text-align: left;
  width: 100%;
  padding: 0 1rem;              /* ruang aman kiri-kanan */
...
#blog h1.display-6 {
  position: relative;
  display: flex;               /* biar bisa pakai justify-content */
  justify-content: center;     /* center horizontal */
  align-items: center;         /* center vertical */
  text-align: center;          /* teks di tengah */
  margin: 0 auto 2rem auto;    /* tengah + jarak bawah */
  font-size: 2rem;
  font-weight: 700;
  color: #2c3e50;
...
#blog h1.display-6::after {
  ...
  height: 4px;
  background-color: #ffc107; /* warna garis */
  border-radius: 2px;
}
...
#blog .container {
  margin-left: 7.6rem; /* geser ke kanan */
 }
/* Kartu Program Studi */
.program-card {
  background: #ffffff;
  ...
  height: 100%;
  max-width: 500px;
  margin: 0 auto; /* biar rata tengah di kolom */
}
...
/* ===== Responsive Layout untuk HP (max 768px) ===== */
@media (max-width: 768px) {
#blog .row {
  display: flex;
  flex-wrap: wrap;
  justify-content: center;  /* bikin semua kolom/card di tengah */
  align-items: center;      /* center secara vertikal kalau tinggi beda */
...
#blog .col-lg-5 {
  display: flex;
  justify-content: center;  /* biar tiap cardnya benar-benar center di kolom */
}

.program-card {
  margin: 0 auto;           /* pastikan cardnya selalu center */
}
  /* Section utama */
  #blog h1.display-6 {
  position: relative;
...
#blog h1.display-6::after {
  ...
  width: 50%;
  height: 3px;
  background-color:  #ffc107; /* warna biru elegan */
  border-radius: 2px;
}
  #blog {
    width: 100%;
    max-width: 100vw;
    overflow-x: hidden; /* cegah konten keluar ke kanan */
    padding: 2rem 0;
    box-sizing: border-box;
  }
  ...
  #blog .container {
    ...
    padding: 0 1rem; /* ruang kiri kanan aman */
    width: 100%;
    max-width: 100%;
    box-sizing: border-box;
    overflow-x: hidden;
  ...
  .program-content {
    ...
    text-align: justify;
    box-sizing: border-box;
    overflow-wrap: break-word; /* biar teks panjang nggak keluar */
    word-wrap: break-word;
    white-space: normal;
  }
